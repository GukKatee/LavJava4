...
public class GraphicsDisplay extends JPanel {
    ...
    public GraphicsDisplay() {
        ...
        graphicsStroke = new BasicStroke(2.0f, BasicStroke.CAP_BUTT, BasicStroke.JOIN_ROUND, 10.0f, new float[]
                {25,5,10,5,5,5,10,5,25,5}, 0.0f);
...
и Y - сколько пикселов
    ...
    protected void paintMarkers(Graphics2D canvas) {
        ...
        // Выбрать  цвет для контуров маркеров
        canvas.setColor(Color.BLACK);
        ...
        for (Double[] point : graphicsData) {
            ...
            canvas.drawLine((int) center.getX() - 7, (int) center.getY() - 7, (int) center.getX() + 7, (int) center.getY() - 7);
            canvas.drawLine((int) center.getX() + 7, (int) center.getY() - 7, (int) center.getX(), (int) center.getY() + 7);
            canvas.drawLine((int) center.getX(), (int) center.getY() + 7, (int) center.getX() - 7, (int) center.getY() - 7);
            canvas.draw(marker);
        }
    }
